  ...
  Redux::setSection( $opt_name, array(
    ...
    'fields'           => array(
      array(
        ...
        'subtitle' => __( 'Recomended size 100px - 200px', 'redux-framework-demo' ),
        'default'  => '',
        //'hint'      => array(
        //    'title'     => 'Hint Title',
  ...
  Redux::setSection( $opt_name, array(
    ...
    'fields'           => array(
      ...
      array(
        'id'       => 'footer-content',
        'type'     => 'editor',
        'title'    => __( 'Footer Content', 'redux-framework-demo' ),
      ),
    )
  ) );
  ...
  Redux::setSection( $opt_name, array(
    ...
    'fields'           => array(
      array(
        'id'       => 'corralina-email',
        'type'     => 'text',
        'title'    => __( 'Enter your e-mail', 'redux-framework-demo' ),
      ...
      array(
        'id'       => 'corralina-phone',
        'type'     => 'text',
        'title'    => __( 'Enter your phone', 'redux-framework-demo' ),
        'subtitle' => __( '', 'redux-framework-demo' ),
      ),
      array(
        'id'       => 'corralina-address',
        'type'     => 'text',
        'title'    => __( 'Enter your address', 'redux-framework-demo' ),
        'subtitle' => __( '', 'redux-framework-demo' ),
      ),
    )
  ) );
